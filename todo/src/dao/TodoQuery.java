...
public class TodoQuery {
	...
	static {
		...
		SELECT_TODO_LIST_BY_MONTH = "SELECT todo_date todoDate, CONCAT( SUBSTR(todo_content,1,5) , '...')todoContent5 FROM todo WHERE member_id=? AND SUBSTR(todo_date,1,7)=? ORDER BY todo_date ASC";
